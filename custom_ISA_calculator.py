#Created for Codecademy Full Computer Science Course in Python 
#-------------------------------------------
...
class UltraSuperCalculator:
  def __init__(self, name) -> None:
    ...
    self.user_display = ""
    self.update_display(f"Welcome to Daniel's Calculator!")
  ...
  def store_value_to_register(self, value_to_store):
    ...
    print("Value Stored: ", value_to_store, ", Register Address: ", self.numbers_index)
    self.numbers_index += 1
  ...
  def get_last_calculation(self):
    ...
    last_value = f"The last calculated value was: " + str(int(self.history_registers[self.temp_history_index], 2))
...
calc1 = UltraSuperCalculator("Daniel")
